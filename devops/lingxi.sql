...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='代码生成表字段';
...
CREATE TABLE `sl_classes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_sl_classes_project_class` (`project_id`,`class_name`)
...
CREATE TABLE `sl_datasets` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `uuid` varchar(64) NOT NULL COMMENT 'UUID 全局唯一标识',
  ...
  `created_id` int DEFAULT NULL COMMENT '创建人 ID',
  `updated_by` bigint DEFAULT NULL,
  `updated_id` int DEFAULT NULL COMMENT '更新人 ID',
  `created_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `name` (`name`),
  UNIQUE KEY `uq_sl_datasets_uuid` (`uuid`),
  KEY `idx_sl_datasets_name` (`name`),
  KEY `ix_sl_datasets_status` (`status`),
  KEY `ix_sl_datasets_created_id` (`created_id`),
  KEY `ix_sl_datasets_updated_id` (`updated_id`),
  CONSTRAINT `fk_sl_datasets_created_by` FOREIGN KEY (`created_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_sl_datasets_updated_by` FOREIGN KEY (`updated_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
) ENGINE=InnoDB AUTO_INCREMENT=14994 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=15219 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=3948 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `sl_projects` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_sl_projects_uuid` (`uuid`),
  UNIQUE KEY `uq_sl_projects_owner_name` (`owner_id`,`name`),
  KEY `ix_sl_projects_status` (`status`),
  KEY `ix_sl_projects_created_id` (`created_id`),
  KEY `ix_sl_projects_updated_id` (`updated_id`),
  CONSTRAINT `fk_sl_projects_created_by` FOREIGN KEY (`created_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_sl_projects_updated_by` FOREIGN KEY (`updated_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='任务执行日志表';
